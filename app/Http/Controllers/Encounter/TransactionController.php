...
class TransactionController extends Controller
{
    ...
    public static function addTransactions($hn,$encounterId,$transactions,$parentTransactionId=null) {
        ...
        $transactions = array_map(function ($value) {
            return array_except($value,['id','created_at','updated_at','deleted_at','created_by','updated_by','deleted_by','repeatHour','roundHour','limitPerEncounter','limitPerDay','status','statusLog']);
        }, $transactions);
